...
<footer class="site-foot">
  ...
  <div class="shell">
    ...
    <div class="foot-sign" data-sign>
      <p class="foot-sign__name">H English</p>
      <span class="foot-sign__swash" aria-hidden="true">
        <svg viewBox="0 0 700 46" preserveAspectRatio="none" focusable="false">
          <path d="M8,26 C130,46 430,48 694,14 C700,14 700,17 694,18 C430,54 128,52 8,30 C4,29 4,25 8,26 Z"/>
        </svg>
      </span>
